...
saxwe_vowel_data <- read_tsv(file.path("vowel_data","saxwe_vowel_data.tsv"))
```
...
# string in.
lexical_tone_info <- read_tsv(file.path("vowel_data",
...
saxwe_vowel_data_manual <- read_tsv(file.path("vowel_data","saxwe_vowel_data_manual.tsv"))
```
...
# Set up database
path2directory = file.path(file.path("textgrids_and_wavs_manual"))
path2directory
...
features <- read_tsv(file.path("other_resources",
